  ...
  return (
    <div className='w-full flex flex-col gap-[32px]'>
      ...
      <div className='flex items-center gap-4'>
        ...
        <div className='w-[473px] h-[240px]  bg-[#009254] rounded-[16px] px-[40px] py-[35px] flex flex-col items-start gap-[4px]'>
          ...
          <p className='text-[24px] text-[#fff] font-inter mt-2 font-bold'>3,000 Paid Order</p>
          <div className='flex items-center gap-1.5'>
            <p className='font-inter text-xs text-[#fff] font-normal'>2000 Successful</p>
            <p className='font-inter text-xs text-[#fff] font-normal'>400 Returned</p>
            <p className='font-inter text-xs text-[#fff] font-normal'>600 Pending</p>
          </div>
          ...
          <div className='flex w-[265px] flex-col  gap-1 mt-[14px]'>
            <div className='flex flex-col'>
              ...
              <div className='items-center flex justify-between'>
                <p className='font-inter text-[24px] text-[#fff] font-semibold'>₦500,000</p>
                <p className='text-[#FFFFFF] font-inter text-xs'>From 600 Orders</p>
              </div>
            </div>
        ...
        <div className='w-[473px] h-[240px] bg-[#F4FBF6] rounded-[16px] px-[40px] py-[35px] flex flex-col items-start gap-[4px]'>
          <div className='flex items-center justify-between w-full'>
          ...
          <p className='text-[24px] text-[#1A1C1B] font-inter mt-2 font-bold'>₦17,340,000</p>
          <div className='flex items-center gap-1.5'>
            <p>From 2000 Orders</p>

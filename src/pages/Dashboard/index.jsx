...
const Dashboard = () => {
  ...
  return (
    <div className='py-[40px] flex flex-col gap-[26px]'>
        ...
        <div className='flex justify-between'>
            ...
            <div className='border border-[#D9E4ED] rounded-lg w-[190px] h-[74px] flex justify-between p-4 items-center'>
              ...
              <div className='flex flex-col gap-1'>
                <p className='text-[#8B9298] text-[13px] font-inter '>Today's Date</p>
                <p className='font-inter text-[#09111D] text-[13px]'>{new Date().toDateString()}</p>
              </div>
            </div>
        </div>
        <div className='rounded-xl border border-[#D9E4ED] flex justify-between items-center py-4 px-[22px]'>
      ...
      <div className="flex items-center gap-5">
        <div className='w-[754px] p-6 flex flex-col  bg-[#fff]'>
          <div className='flex justify-between p-3'>
            <div className='flex flex-col gap-2'>
              <p className='text-[#111827] font-inter text-[20px] font-semibold'>Product Category Performance</p>
              <div className='flex items-center gap-4'>
            ...
            <div className='flex items-center border border-[#E9EAEC] rounded-lg  p-2 gap-1'>
              <p className='text-[#111827] font-medium text-xs font-inter'>Last 7 month</p>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.99992 5.29167C4.42462 5.29167 3.95825 5.75804 3.95825 6.33333V16.3333C3.95825 16.9086 4.42462 17.375 4.99992 17.375H14.9999C15.5752 17.375 16.0416 16.9086 16.0416 16.3333V6.33333C16.0416 5.75804 15.5752 5.29167 14.9999 5.29167H4.99992ZM2.70825 6.33333C2.70825 5.06768 3.73427 4.04167 4.99992 4.04167H14.9999C16.2656 4.04167 17.2916 5.06768 17.2916 6.33333V16.3333C17.2916 17.599 16.2656 18.625 14.9999 18.625H4.99992C3.73427 18.625 2.70825 17.599 2.70825 16.3333V6.33333Z" fill="#111827"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M13.3333 2.375C13.6784 2.375 13.9583 2.65482 13.9583 3V6.33333C13.9583 6.67851 13.6784 6.95833 13.3333 6.95833C12.9881 6.95833 12.7083 6.67851 12.7083 6.33333V3C12.7083 2.65482 12.9881 2.375 13.3333 2.375Z" fill="#111827"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M6.66659 2.375C7.01176 2.375 7.29158 2.65482 7.29158 3V6.33333C7.29158 6.67851 7.01176 6.95833 6.66659 6.95833C6.32141 6.95833 6.04159 6.67851 6.04159 6.33333V3C6.04159 2.65482 6.32141 2.375 6.66659 2.375Z" fill="#111827"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M2.70825 9.66667C2.70825 9.32149 2.98807 9.04167 3.33325 9.04167H16.6666C17.0118 9.04167 17.2916 9.32149 17.2916 9.66667C17.2916 10.0118 17.0118 10.2917 16.6666 10.2917H3.33325C2.98807 10.2917 2.70825 10.0118 2.70825 9.66667Z" fill="#111827"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.33325 13C8.33325 12.5398 8.70635 12.1667 9.16658 12.1667H9.99992C10.4602 12.1667 10.8333 12.5398 10.8333 13C10.8333 13.4602 10.4602 13.8333 9.99992 13.8333H9.16658C8.70635 13.8333 8.33325 13.4602 8.33325 13Z" fill="#111827"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.99992 12.375C10.3451 12.375 10.6249 12.6548 10.6249 13V15.5C10.6249 15.8452 10.3451 16.125 9.99992 16.125C9.65474 16.125 9.37492 15.8452 9.37492 15.5V13C9.37492 12.6548 9.65474 12.375 9.99992 12.375Z" fill="#111827"/>
              </svg>
            </div>
          </div>
        ...
        <div className='w-full h-[382px] flex flex-col bg-[#fff] gap-[18px] p-[18px] border rounded-lg'>
          ...
          <div className='flex flex-col gap-4'>
            {
              bestSellingItemsData?.map((item, index) => (
              
                <div key={index} className='flex items-center justify-between'>
                  <div className='flex items-center gap-1.5'>
                      <div className='bg-[#C4C4C4] w-[36px] h-[36px] rounded-lg'></div>
                      <p className='font-inter text-[11px] text-[#333] font-medium'>{item?.name}</p>
                  </div>
                  <p className='text-[#667185] text-[11px] font-inter'>{item?.totalOrders}</p>
                </div>
              ))
            }
          </div>
      ...
      <div className='bg-[#fff] w-full rounded-xl px-[24px] py-[15px] gap-[39px] flex flex-col'>
            ...
            {orderData?.length > 1 ? orderData?.map((item, index) => (
                <tr key={index} className='bg-white h-[56px] border-t cursor-pointer border-grey-100'>
                    <td className='h-[70px] px-4'>
                        <p className='text-sm font-manrope text-[#101828] text-left'>{item?.id}</p> 
                    </td>
                    <td className='h-[70px] px-4'>

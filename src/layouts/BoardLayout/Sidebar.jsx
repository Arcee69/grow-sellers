  ...
  return (
    <div className='bg-[#fff] flex flex-col gap-6 '>
        ...
        <div className='flex flex-col items-center gap-4'>
            ...
            <div onClick={() => { window.open("https://growafrica.shop", "blank"), window.scrollTo(0, 0) }} className={`w-[222px] h-[48px] rounded-lg  gap-2 flex items-center group cursor-pointer transition-all duration-300 p-[16px] hover:bg-[#ECFFF6]`}>

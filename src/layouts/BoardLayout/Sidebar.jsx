  ...
  return (
    <div className='bg-[#fff] flex flex-col gap-6 '>
        ...
        <div className='flex flex-col items-center gap-4'>
            <div 
                onClick={() => {userData?.kyc_status === "pending" ? null : navigate("/dashboard"), window.scrollTo(0, 0)}} 
            ...
            <div 
                onClick={() => {userData?.kyc_status === "pending" ? null : navigate("/inventory"), window.scrollTo(0, 0)}} 
            ...
            <div 
                onClick={() => {userData?.kyc_status === "pending" ? null : navigate("/orders"), window.scrollTo(0, 0)}} 
            ...
            <div 
                onClick={() => {userData?.kyc_status === "pending" ? null : navigate("/sales"), window.scrollTo(0, 0)}} 
